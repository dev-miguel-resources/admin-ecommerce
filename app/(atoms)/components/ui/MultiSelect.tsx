...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  // Para cada colleción, se verifica si no está incluid en selected, para que solo
  // las collecciones que no han seleccionadas sean incluidas como seleccionables
